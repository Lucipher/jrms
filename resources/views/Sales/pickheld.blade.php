...
<head>
    ...
    <style>
        ...
        table#ItemTablepick tr:nth-child(n+1) {
            counter-increment: rowNumber;
        }

        table#ItemTablepick tr:nth-child(n+1) td:first-child::before {
                ...
                <div class="card">
                        ...
                        <div class="row clearfix">
                                <div class="col-md-3">
                                    ...
                                    <div class="content">
                                        ...
                                        style="font-size: 250%; font-style: oblique; font-family: 'Times';">Pick Held Invoice</h1>
                                    </div>
                                    </div>
                                </div>
                        </div>
                    ...
                    <div class="header bg-white">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" id="P_Inum" name="P_Inum" class="form-control" autofocus/>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="demo-masked-input">
                                    ...
                                    <p>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-line">
                                                    <input id="fromdate" name="fromdate" type="text" class="form-control date" placeholder="31/12/2020">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-line">
                                                    <input id="todate" name="todate" type="text" class="form-control date" placeholder="31/12/2020">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <p>
                                        ...
                                        <div class="form-line">
                                            <input list="itname" class="form-control date" id="P_ItemsList" name="P_ItemsList">
                                            <datalist id="itname">
                                 ...
                                 <div class="col-md-2">
                                    ...
                                    <p><b>Generated By</b></p>
                                        <div class="form-line">
                                            <input list="generated" class="form-control date" id="P_Generated" name="P_Generated" >
                                ...
                                <div class="col-md-2">
                                    <p><b>&nbsp;</b></p>
                                    <button type="button" id="Pick_Search" name="Pick_Search" class="btn bg-cyan waves-effect" onclick="PickHeldSearch()">
                                        <i class="material-icons">search</i>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="table-responsive">
                                        <table id="ItemTablepick" name="ItemTablepick" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                            <thead align="left">
                                                <tr>
